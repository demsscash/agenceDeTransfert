...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar2">
            <div class="logo">
                <a href="#">
                    <img src="{{asset('img/logo.png')}}" alt="" style="height: 60px;width: 60px;float: left;" />
                </a>
        ...
        <div class="page-container2">
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap2">
                            <div class="logo d-block d-lg-none">
                                <a href="#">
                                    <img src="{{asset('img/logo.png')}}" alt="CoolAdmin" style="height: 60px;width: 60px;float: left;"/>
                                </a>
                            </div>
            ...
            <aside class="menu-sidebar2 js-right-sidebar d-block d-lg-none">
                <div class="logo">
                    <a href="#">
                        <img src="{{asset('img/logo.png')}}" alt="" style="height: 60px;width: 60px;"/>
                    </a>
                </div>
                <div class="menu-sidebar2__content js-scrollbar2">
                    <div class="account2">
                        <div class="image img-cir img-120">
                            <img src="{{asset('img/avatar.png')}}" alt="John Doe" />
                        </div>
                        <h4 class="name">{{ Auth::user()->name }}</h4>
                        <a href="{{ route('logout') }}">Deconnexion</a>
                    </div>
