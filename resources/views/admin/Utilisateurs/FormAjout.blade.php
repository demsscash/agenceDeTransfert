            ...
            <form class="form-horizontal AjoutUtilisateur" id="AjoutUtilisateur" method="post" action="admin/ajout">
                ...
                <div class="gauche">
                    ...
                    <div class="form-group row" >
                        ...
                        <div class="col-md-6">                                    
                        <input id="name" type="text" class="form-control" placeholder="{{ __('Nom') }}" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6"> 
                        <input id="prenom" type="text" class="form-control" placeholder="{{ __('prenom') }}" required> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6"> 
                        <input id="tel" type="text" class="form-control" placeholder="{{ __('tel') }}" required>
                    ...
                    <div class="form-group row">         
                        ...
                        <div class="col-md-6">                   
                        <input id="nni" type="text" class="form-control" placeholder="{{ __('nni') }}" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6"> 
                        <input id="login" type="text" class="form-control" placeholder="{{ __('login') }}" required>
                ...
                <div class="droite">
                    <div class="form-group row">
                        ...
                        <div class="col-md-6"> 
                        <input id="email" type="email" class="form-control" placeholder="{{ __('E-Mail Address') }}" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6"> 
                        <input id="password" type="password" class="form-control" placeholder="{{ __('Password') }}" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6"> 
                        <input id="password-confirm" type="password" class="form-control" placeholder="{{ __('Confirm Password') }}" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6"> 
                        <select id="type_user" class="form-control type"> 
                   ...
                   <label for="point" class="col-md-4 col-form-label text-md-right">{{ __('point de transfert') }}</label>   
                        ...
                        <select id="id_pnt" class="form-control ptrans" ></select>                     
                   </div>
                  </div>
