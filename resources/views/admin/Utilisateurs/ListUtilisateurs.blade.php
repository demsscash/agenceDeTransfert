    ...
    <div class="TableauU">
	    <div class="listtitre">
	    <h3>Listes Des Utilisateurs <button class="btn  bajouter" id="Ajouter"><i class="fa fa-plus"></i> Ajouter</button>   <a href="{{ route('listeUtilisateur') }}" class="btn btn-primary"><i class="fa fa-export"></i> exporter</a></h3>
	    </div>
	    ...
	    <table class="table table-striped table-bordered tbD tbDD animated fadeIn" id="myTable">
	        ...
	        <tbody>
	            ...
	            <tr>
	                ...
	                <td>{{$row->email}}</td>
	                <td>
	                    <button class="btn btn-info Modif" value="{{$row->id}}"><i class="fa fa-pencil" title="Edit"></i> </button>
	                    <button data-toggle="modal" data-target="#supp" data-original-title class="btn btn-danger Supp" value="{{$row->id}}"><i class="fa fa-trash-o" title="Delete"></i></button>
